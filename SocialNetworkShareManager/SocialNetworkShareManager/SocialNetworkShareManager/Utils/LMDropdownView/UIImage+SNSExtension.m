...
@implementation UIImage (SNSExtension)

#pragma mark - CREATE IMAGE

+ (UIImage *)sns_imageFromView:(UIView *)theView withSize:(CGSize)size
{
//    UIGraphicsBeginImageContext(size);
    //change by yan_wan, this func capture screen is not so good, use the func below
...
- (UIImage *)sns_blurredImageWithRadius:(CGFloat)radius
