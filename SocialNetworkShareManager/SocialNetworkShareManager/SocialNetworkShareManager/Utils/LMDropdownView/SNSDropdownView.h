...
/*!
 Dropdown view state.
 */
typedef NS_ENUM(NSUInteger, SNSDropdownViewState) {
    SNSDropdownViewStateWillOpen,
    SNSDropdownViewStateDidOpen,
    SNSDropdownViewStateWillClose,
    SNSDropdownViewStateDidClose,
};

typedef NS_ENUM(NSUInteger, SNSDropdownViewDirection) {
    SNSDropdownViewDirectionTop,
    SNSDropdownViewDirectionBottom,
};

@protocol SNSDropdownViewDelegate;

/*!
 *  A simple dropdown view inspired by Tappy.
 */
@interface SNSDropdownView : NSObject
 ...
 */
@property (nonatomic, assign) SNSDropdownViewDirection direction;
 ...
 */
@property (nonatomic, assign, readonly) SNSDropdownViewState currentState;
 ...
 */
@property (nonatomic, weak) id<SNSDropdownViewDelegate> delegate;
...
/*!
 *  Convenience constructor for SNSDropdownView.
 */
 ...
 */
@protocol SNSDropdownViewDelegate <NSObject>
