...
@implementation GxShareVideoHelper
...
+(void)uploadFacebookVideo:(NSData*)videoData comment:(NSString*)comment account:(ACAccount*)account withCompletion:(VideoUploadCompletion)completion{
    ...
    [request performRequestWithHandler:^(NSData *responseData, NSHTTPURLResponse *urlResponse, NSError *error) {
        ...
        if (error) {
            ...
            [GxShareVideoHelper uploadError:error withCompletion:completion];
        } else {
            ...
            [GxShareVideoHelper facebookVideoStage2:videoData comment:(NSString*)comment upload_session_id:upload_session_id account:account withCompletion:completion];
        }
    }];
...
+(void)facebookVideoStage2:(NSData*)videoData comment:(NSString*)comment upload_session_id:(NSString *)upload_session_id account:(ACAccount*)account withCompletion:(VideoUploadCompletion)completion{
    ...
    [request performRequestWithHandler:^(NSData *responseData, NSHTTPURLResponse *urlResponse, NSError *error) {
        ...
        if (error) {
            ...
            [GxShareVideoHelper facebookVideoStage3:videoData comment:(NSString*)comment upload_session_id:upload_session_id account:account withCompletion:completion];
        }
    }];
}
...
+(void)facebookVideoStage3:(NSData*)videoData comment:(NSString*)comment upload_session_id:(NSString *)upload_session_id account:(ACAccount*)account withCompletion:(VideoUploadCompletion)completion{
    ...
    if (comment == nil) {
        comment = [NSString stringWithFormat:@"#GxShareVideoHelper# https://github.com/liu044100/GxShareVideoHelper"];
    }
    ...
    [request performRequestWithHandler:^(NSData *responseData, NSHTTPURLResponse *urlResponse, NSError *error) {
        ...
        if (error) {
            ...
            if ([urlResponse statusCode] == 200){
                ...
                [GxShareVideoHelper uploadSuccessWithCompletion:completion];
            }
        }
    }];
}
...
+(void)uploadTwitterVideo:(NSData*)videoData comment:(NSString*)comment account:(ACAccount*)account withCompletion:(VideoUploadCompletion)completion{
    ...
    [request performRequestWithHandler:^(NSData *responseData, NSHTTPURLResponse *urlResponse, NSError *error) {
        ...
        if (error) {
            ...
            [GxShareVideoHelper tweetVideoStage2:videoData mediaID:mediaID comment:comment account:account withCompletion:completion];
...
+(void)tweetVideoStage2:(NSData*)videoData mediaID:(NSString *)mediaID comment:(NSString*)comment account:(ACAccount*)account withCompletion:(VideoUploadCompletion)completion{
    ...
    NSArray *chunks = [GxShareVideoHelper separateToMultipartData:videoData];
...
//                    theError = error;
                    ...
                    if (i == requests.count - 1) {
                        [GxShareVideoHelper tweetVideoStage3:videoData mediaID:mediaID comment:comment account:account withCompletion:completion];
                    }
                }
...
//        if (theError) {
//            [GxShareVideoHelper uploadError:theError withCompletion:completion];
//        } else {
...
+(void)tweetVideoStage3:(NSData*)videoData mediaID:(NSString *)mediaID comment:(NSString*)comment account:(ACAccount*)account withCompletion:(VideoUploadCompletion)completion{
    ...
    [postRequest performRequestWithHandler:^(NSData *responseData, NSHTTPURLResponse *urlResponse, NSError *error) {
        ...
        if (error) {
            ...
            [GxShareVideoHelper tweetVideoStage4:videoData mediaID:mediaID comment:comment account:account withCompletion:completion];
        }
    }];
}
...
//                NSLog(@"Twitter STATUS upload success !");
                ...
                if ([state  isEqual: @"in_progress"]) {
                    ...
                    [GxShareVideoHelper tweetVideoStage5:videoData mediaID:mediaID comment:comment account:account withCompletion:completion];
                }
            }
        }
    }];
